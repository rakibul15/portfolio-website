...
import { scenarios, type HeapScenario } from '@/lib/lab/heap-data'
import { HeapTreeView } from './heap-tree-view'
...
export function HeapViz() {
  ...
  const scenario: HeapScenario = scenarios[scenarioIndex]
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex lg:hidden flex-col gap-4">
        <HeapTreeView step={step} heapKind={scenario.heapKind} />
        <HeapArrayView step={step} />
      ...
      <div className="hidden lg:block">
        <Group orientation="horizontal" className="min-h-[640px]">
