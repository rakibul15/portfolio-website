...
import { scenarios, type JSUtilScenario } from '@/lib/lab/js-utilities-data'
...
export function JSUtilitiesViz() {
  ...
  const scenario: JSUtilScenario = scenarios[scenarioIndex]
