...
import { scenarios, type DPScenario } from '@/lib/lab/dp-data'
...
export function DPViz() {
  ...
  const scenario: DPScenario = scenarios[scenarioIndex]
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Variables panel above (always visible) */}
      {step.vars.length > 0 && (
        <div className="border border-stroke">
      ...
      <div className="hidden lg:block">
        <Group orientation="horizontal" className="min-h-[480px]">
