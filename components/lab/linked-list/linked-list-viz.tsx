...
import { scenarios, type LLScenario } from '@/lib/lab/linked-list-data'
...
export function LinkedListViz() {
  ...
  const scenario: LLScenario = scenarios[scenarioIndex]
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="hidden lg:block">
        <Group orientation="horizontal" className="min-h-[520px]">
          ...
          <Panel defaultSize={38} minSize={25} className="min-w-0">
