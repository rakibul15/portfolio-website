        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
            ...
            <div className="w-[180px] h-[220px] lg:w-[200px] lg:h-[260px] border border-stroke overflow-hidden relative bg-paper2">
              {!imgError ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <span className="font-serif text-[48px] font-black text-stroke">
                    RH
                  </span>
                </div>
              )}
          ...
          <div>
            <motion.p
              ...
              className="text-[15px] text-muted leading-[1.8] font-light max-w-[560px]"
            >
            ...
            <motion.p
              ...
              className="text-[15px] text-muted leading-[1.8] font-light max-w-[560px] mt-4"
            >
